...
namespace NovelSystems
{
    ...
    {
        [Header("クリップ管理")]
        [SerializeField] private NovelAudioClipTable audioTable;
        ...
        private static NovelAudioManager instance;
        public static NovelAudioManager Instance => instance;
        ...
        {
            // BGM
            GameObject bgmObj = new GameObject("Novel_BGM_Box");
            ...
            // SE
            GameObject seObj = new GameObject("Novel_SE_Box");
